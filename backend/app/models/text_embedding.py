...
class TextEmbedding(Base):
    ...
    # For MySQL, we'll store as JSON array
    ...
    embedding_metadata = Column(JSON, default=lambda: {})  # stakeholder_ids, topics, date, etc.
    
    # Content classification
    language = Column(String(5), default="EN")
    content_type = Column(String(50))  # 'transcript', 'insight', 'action', 'quote'
    confidence_score = Column(String(255))  # Embedding quality score
...
# 1. Composite index for source filtering
source_index = Index(
...
# 2. Temporal index for time-based queries
